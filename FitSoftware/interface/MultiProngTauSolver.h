...
class  MultiProngTauSolver {
 public:
  ...
  static void quadratic(double &x_plus,double &x_minus,double a, double b, double c, bool &isReal,const double &padding);
  static void AnalyticESolver(TLorentzVector &nu_plus,TLorentzVector &nu_minus,TLorentzVector A1,bool &isReal,const double &padding);
  static void NumericalESolver(TLorentzVector &nu_plus,TLorentzVector &nu_minus,TLorentzVector A1);
  static void SolvebyRotation(TVector3 TauDir,TLorentzVector A1, TLorentzVector &Tau_plus,TLorentzVector &Tau_minus,TLorentzVector &nu_plus,TLorentzVector &nu_minus,bool &isReal,const double &padding,bool rotateback=true);
